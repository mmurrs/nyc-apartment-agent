...
{"neighborhood_name": string|null, "beds": number[]|null (0=studio),
 ...
 "sublet": boolean (true for sublease/short-term/temporary stays), "duration_months": number|null,
 "features": string[] (from: natural_light,laundry,dishwasher,outdoor_space,pets,doorman,elevator,gym,renovated,exposed_brick,hardwood,quiet,no_fee,furnished),
